...
import React from "react"; // only needed in certain configurations
...
export default function Home() {
  ...
  const categoryDescriptions = {
    ...
    Reports:
      "Generate reports, summaries, and more with ease and precision.",
  };

    // Handle hover to change title and description
    const handleMouseEnter = (categoryText) => {
    ...
    <div className="bg-white min-h-screen">
      <main className="w-full max-w-7xl mx-auto px-6 lg:px-20">
        ...
        <section className="text-center py-32">
          ...
          Growing crops is tough. Making sense of the data shouldn’t be. With our interactive flowchart, you can track, compare, and act—boosting yields and solving problems faster.
          </p>
          ...
          <div className="mt-12 flex justify-center items-center text-gray-600">
            ...
            <p className="ml-4 text-sm">Founded in Boston, MA at MIT Energy Hackathon</p>
          </div>
        </section>
        ...
        <section className="py-32">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Charts & Graphs</h3>
              <p className="text-sm text-gray-600">Create sleek looking data visualizations.</p>
            </div>
            ...
            >
              ...
              <p className="text-sm text-gray-600">Ask complex questions and receive actionable insights.</p>
            </div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Advanced Analysis</h3>
              <p className="text-sm text-gray-600">Perform predictive modeling and advanced data forecasting.</p>
            </div>
            ...
            >
              ...
              <p className="text-sm text-gray-600">Generate polished reports and summaries effortlessly.</p>
            </div>
          </div>
